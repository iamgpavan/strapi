...
export interface ApiAuditLogAuditLog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'System audit logs for content changes';
    displayName: 'Audit Log';
    pluralName: 'audit-logs';
    singularName: 'audit-log';
  };
  ...
  attributes: {
    action: Schema.Attribute.Enumeration<['create', 'update', 'delete']> &
      Schema.Attribute.Required;
    afterData: Schema.Attribute.JSON;
    beforeData: Schema.Attribute.JSON;
    changedFields: Schema.Attribute.JSON;
    contentType: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    fullPayload: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    userType: Schema.Attribute.Enumeration<['admin', 'api', 'system']> &
